...
public sealed partial class RequisitionsElevatorComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier? LoweringSound = new SoundPathSpecifier("/Audio/_Nuclear14/Machines/asrs_lowering.ogg");

    [DataField]
    public SoundSpecifier? RaisingSound = new SoundPathSpecifier("/Audio/_Nuclear14/Machines/asrs_raising.ogg");
...
public enum N14RequisitionsElevatorLayers
{
    Base,
}
